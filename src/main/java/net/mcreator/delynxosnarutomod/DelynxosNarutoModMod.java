package net.mcreator.delynxosnarutomod;
...
@Mod("delynxos_naruto_mod")
public class DelynxosNarutoModMod {
	public static final Logger LOGGER = LogManager.getLogger(DelynxosNarutoModMod.class);
	public static final String MODID = "delynxos_naruto_mod";

	public DelynxosNarutoModMod(IEventBus modEventBus) {
